...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-white ring-1 ring-slate-200 transform transition-transform ${
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <header className="bg-white ring-1 ring-slate-200 sticky top-0 z-20">
          <div className="h-16 flex items-center justify-between px-4 sm:px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="text-sm font-semibold text-slate-700 hover:text-rose-600 px-3 py-2 rounded-lg hover:bg-rose-50"
              >
                Keluar
              </button>
            </div>
