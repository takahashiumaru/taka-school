        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="mt-5 text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 dark:text-slate-100">
              ...
              orang tua selalu <span className="text-primary-600 dark:text-primary-400">terinfo</span>.
            </h1>
            <p className="mt-5 text-lg text-slate-600 max-w-xl dark:text-slate-300">
              ...
              Orang tua otomatis dapat info anaknya lewat <span className="font-semibold text-emerald-600 dark:text-emerald-400">WhatsApp</span>,
            ...
            <dl className="mt-10 grid grid-cols-3 gap-6 max-w-md">
              <div>
                <dt className="text-2xl font-bold text-slate-900 dark:text-slate-100">9</dt>
                <dd className="text-sm text-slate-500 dark:text-slate-400">modul siap pakai</dd>
              </div>
              <div>
                <dt className="text-2xl font-bold text-slate-900 dark:text-slate-100">2 menit</dt>
                <dd className="text-sm text-slate-500 dark:text-slate-400">tambah siswa baru</dd>
              </div>
              <div>
                <dt className="text-2xl font-bold text-slate-900 dark:text-slate-100">0</dt>
                <dd className="text-sm text-slate-500 dark:text-slate-400">app untuk ortu</dd>
              </div>
            </dl>
          </div>
          ...
          <div className="relative">
              ...
              <div className="rounded-2xl bg-white ring-1 ring-slate-200 overflow-hidden dark:bg-slate-900 dark:ring-slate-800">
                ...
                <div className="p-5 space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-xs text-slate-500 dark:text-slate-400">Selamat pagi,</div>
                      <div className="text-lg font-semibold text-slate-900 dark:text-slate-100">Bu Echa 👋</div>
                    </div>
                    <div className="text-xs text-slate-500 dark:text-slate-400">Kamis · 6 Mei 2026</div>
                  </div>

                  <div className="grid grid-cols-3 gap-3">
                    <div className="rounded-xl bg-primary-50 p-3 dark:bg-primary-500/10">
                      <div className="text-xs text-primary-700 dark:text-primary-300">Siswa Hadir</div>
                      <div className="text-xl font-bold text-primary-800 dark:text-primary-200">22<span className="text-sm text-primary-500 dark:text-primary-400">/24</span></div>
                    </div>
                    <div className="rounded-xl bg-emerald-50 p-3 dark:bg-emerald-500/10">
                      <div className="text-xs text-emerald-700 dark:text-emerald-300">Lunas SPP</div>
                      <div className="text-xl font-bold text-emerald-800 dark:text-emerald-200">87%</div>
                    </div>
                    <div className="rounded-xl bg-amber-50 p-3 dark:bg-amber-500/10">
                      <div className="text-xs text-amber-700 dark:text-amber-300">Rapor</div>
                      <div className="text-xl font-bold text-amber-800 dark:text-amber-200">4 lagi</div>
                    </div>
                  </div>

                  <div className="rounded-xl ring-1 ring-slate-200 p-3 dark:ring-slate-800">
                    <div className="text-xs font-semibold text-slate-500 mb-2 dark:text-slate-400">Absensi Hari Ini · Kelas A</div>
                  ...
                  <div className="flex items-center justify-between rounded-xl bg-emerald-50 ring-1 ring-emerald-100 p-3 dark:bg-emerald-500/10 dark:ring-emerald-500/30">
                    ...
                    <span className="text-xs text-emerald-700 font-semibold dark:text-emerald-300">✓</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="hidden sm:flex absolute -bottom-6 -left-6 items-center gap-3 rounded-2xl bg-white p-3 ring-1 ring-slate-200 shadow-soft dark:bg-slate-900 dark:ring-slate-800">
              ...
              <div>
                <div className="text-xs text-slate-500 dark:text-slate-400">Pesan terkirim ke ortu</div>
                <div className="text-sm font-semibold text-slate-900 dark:text-slate-100">via WhatsApp ✓</div>
              </div>
            </div>
          </div>
        </div>
