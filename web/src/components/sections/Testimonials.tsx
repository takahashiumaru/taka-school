    ...
    <section className="section">
      <div className="max-w-7xl mx-auto container-px">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-5">
          {items.map((t) => (
            <figure key={t.name} className="rounded-2xl bg-gradient-to-br from-primary-50 to-white ring-1 ring-slate-200 p-6">
              ...
              <figcaption className="mt-5 flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-primary-200 text-primary-800 flex items-center justify-center font-bold">
                  {t.name.split(" ").pop()?.[0]}
                </div>
                <div>
